...
const jobs = [
  {
    ...
    jobType: 'Віддалено',
    role: 'Тьютор курсу Full Stack Web Developer',
    challenges: [
...
export const content = {
  ...
  AboutSection: {
    ...
    paragraphsList: [
      ...
      {
        paragraph: "Коли я не пишу код, то веду блоги, читаю або займаюся новими творчими проєктами, такими як фотографія.",
      },
      {
        paragraph: "З сильним акцентом на вирішення проблем, управління клієнтами та проєктами, а також аналітичне мислення, я самоорганізований і готовий створювати потужні веб-рішення, що відповідають бізнес-цілям.",
      },
    ]
  },
  SkillsSection: {
