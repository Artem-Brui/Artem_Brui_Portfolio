import { Bootstrap, Bulma, Css, Express, Figma, Git, Html, Javascript, Mongodb, React, Redux, Sass, Tailwind, Typescript, UaFlag } from "../components/SVGs/Icons";
...
const skills = [
  {
    ...
    logo: Html,
    logoColor: '#e95829',
    descreption: 'Основа будь-якого вебсайту, мова розмітки для структурування та відображення контенту.',
  },
  {
    name: 'css',
    logo: Css,
    logoColor: '#27a3d9',
    descreption: 'Мова для стилізації вебсторінок, що визначає кольори, шрифти, відступи та інші візуальні елементи.',
  },
  {
    name: 'bootstrap',
    logo: Bootstrap,
    logoColor: '#7711f2',
    descreption: 'Набір попередньо розроблених стилів та компонентів для швидкого створення адаптивних і стильних вебсторінок.',
  },
  {
    name: 'bulma',
    logo: Bulma,
    logoColor: '#09caad',
    descreption: 'Легка CSS-фреймворк з елегантними компонентами, що спрощує створення сучасних вебсайтів.',
  },
  {
    name: 'tailwind',
    logo: Tailwind,
  ...
  },
  {
    ...
    logo: Sass,
    logoColor: '#cb6197',
    descreption: 'Препроцесор CSS, що додає змінні, вкладення та інші функції для спрощення та організації стилізації.',
  },
  {
    name: 'git',
    logo: Git,
    logoColor: '#e84e32',
    descreption: 'Система контролю версій для відстеження та управління змінами коду, ідеальна для командної роботи.',
  },
  {
    name: 'figma',
    logo: Figma,
    logoColor: '#29befe',
    descreption: 'Потужний інструмент для дизайну та прототипування, який дозволяє спільно працювати в реальному часі та оптимізувати процеси UI/UX.',
  },
  {
    name: 'javascript',
    logo: Javascript,
    logoColor: '#c19e38',
    descreption: 'Мова програмування, яка робить вебсайти інтерактивними (наприклад, кнопки, спливаючі вікна).',
  },
  {
    name: 'typescript',
    logo: Typescript,
    logoColor: '#0076c6',
    descreption: '«Посилена» версія JavaScript з перевіркою типів для спрощення розробки та зменшення кількості помилок.',
  },
  {
    name: 'react',
    logo: React,
    logoColor: '#0bb4d2',
    descreption: 'Бібліотека для створення інтерактивних користувацьких інтерфейсів за допомогою компонентів.',
  },
  {
    name: 'redux',
    logo: Redux,
    logoColor: '#7348b6',
    descreption: 'Інструмент для управління станом додатків, що полегшує роботу з даними.',  
  },
  {
    name: 'express',
    logo: Express,
    logoColor: '#000000',
    descreption: 'Мінімалістичний бекенд-фреймворк для створення API та вебдодатків на Node.js.',  
  },
  {
    name: 'mongodb',
    logo: Mongodb,
    logoColor: '#559034',
    descreption: 'База даних, у якій дані зберігаються у вигляді об’єктів, схожих на JSON, ідеальна для сучасних додатків.',  
  },
];
...
const jobs = [
  {
    ...
    challenges: [
      "Стислі терміни для вивчення нових тем до рівня викладання.",
    ],
    achievements: [
...
export const content = {
  ...
  HomeSection: {
    ...
    descreption: "Орієнтований на створення якісного коду, побудову ефективної комунікації та допомогу команді в досягненні успіху.",
  ...
  AboutSection: {
    ...
    paragraphsList: [
      {
        paragraph: "Мене звати Артем, і я спеціалізуюся на веб-розробці, використовуючи JavaScript, TypeScript, React, Express та MongoDB тощо.",
      },
      {
        paragraph: "Я високомотивована людина та вічний оптиміст, присвячений написанню чіткого, зрозумілого та надійного коду, який працює. Постійно прагну навчатися та вдосконалюватися.",
      },
      {
        paragraph: "Маючи досвід у вирішенні складних задач, управлінні проєктами та аналізі даних, я розробляю веб-рішення, які ефективно підтримують бізнес-стратегію.",
      },
      {
        paragraph: "Коли я не пишу код, я присвячую час велосипедним прогулянкам, заняттям спортом, пробіжкам та радісним моментам із дружиною і двома чудовими дітьми.",
      },
    ]
  },
  SkillsSection: {
  ...
  ExperienceSection: {
    sectionName: 'Досвід',
    sectionHeader: 'Я мав честь співпрацювати з неймовірними командами та впливовими проєктами',
    present: 'до тепер',
    jobs: jobs,
    titles: {
      challenges: 'Виклики',
